...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::skills::preview_skill_file_save,
            commands::skills::save_skill_file,
            commands::skills::get_source_skill_document,
            commands::skills::get_skill_source_diff,
            commands::skills::preview_skillssh_skill,
            commands::skills::check_skill_quality,
            commands::skills::export_skill_archive,
            commands::skills::get_skill_audit_history,
            commands::skills::list_skill_edit_snapshots,
            commands::skills::restore_skill_edit_snapshot,
            ...
            commands::settings::import_appearance_media,
